class LoggerMessages:
    ...
    VEHICLE_CREATED_SUCCESS = "{} created successfully."
    VEHICLE_CREATION_FAILED = "Failed to create vehicle of type: {}"
    VEHICLE_STARTING_ALL = "Starting all engines..."
    ENGINE_STARTED = "{} Engine started ===> vroom vroom!"